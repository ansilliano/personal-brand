...
import iconModal from '../../../assets/img/experiencie/img-experience-3.png';

const Petararte = () => {
  return (
    <div className='experiencie__petararte experiencie-modal future-modal'>
      <svg
        width={650}
        height={319}
        viewBox='0 0 774 319'
      ...
      <div div className='container-modal'>
        ...
        <span>
          <p>
            Pe+Arte was a Program from the Community Service of the Coordination
            of Complementary General Training of the Simón Bolívar University
            that consisted of the artistic intervention for the re-significance
            of neglected or forgotten public spaces of the Historic Center of
            Petare in order to improve the quality of life of their community
            through a disruptive experience.
          </p>
        </span>
      </div>
    </div>
