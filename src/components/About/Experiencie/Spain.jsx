...
import iconModal from '../../../assets/img/experiencie/img-experience-1.png';
/* eslint-disable max-len */

const Spain = () => {
  return (
    <div className='experiencie__spain experiencie-modal future-modal'>
      <svg
        width={650}
        height={300}
        viewBox='0 0 774 347'
      ...
      <div div className='container-modal-left'>
        ...
        <span>
          <p>
            Position as a Project Architect in the preliminary design and
            initial supervision stage of the remodeling work.
          </p>
          <br />
          <p>
            The objective was to consolidate different entities of the Spanish
            government in a single space, with the objective of transform a
            2600m2 building.
          </p>
          <br />
          <p>
            Handling of Revit, Sketchup, Autocad, Illustrator and Photoshop.
          </p>
        </span>
      </div>
    </div>
